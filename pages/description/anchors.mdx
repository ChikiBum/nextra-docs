...
The functionality was developed as part of feature HP-5599, described in the
task as follows:
...
1. Open the admin panel, navigate to HBMP Marketplace -> Site Settings -> select the pencil icon next to the website -> click on the
2. "Add parameter" button and add the key "anchors"
